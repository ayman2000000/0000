...
var handlePlaceholder = '<div class="in_room_element list_element">' +
        '<div class="in_room_icon"><div class="placeholder room_icon_placeholder round5"></div></div>' +
        '<div class="in_room_name"><div class="placeholder w100 round5">&nbsp;</div></div>' +
        '<div class="in_room_count rtl_aleft"><div class="placeholder round5 w100">&nbsp;</div></div>' +
        '</div>';
...
function copyText(elementId) {
	...
	tempInput.remove();
	callSuccess('تم النسخ الى الحافظة');
  }
...
$(document).ready(function(){
	...
	hideTopAd = function() {
		$('#top_ad_close').slideUp(100);
		$('#special_space').slideUp(100);
		setTimeout(function() {
			$('#special_space').slideDown(100);
			setTimeout(function() {
				$('#top_ad_close').slideDown(100);
			}, 2500);
		}, 90000);
